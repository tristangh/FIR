    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rel_start_date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(SpreadSheet.this, dateFrom, myCalendar
    ...
    public void insertData(final String enter_type, final String enter_status, final String enter_member,
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                loading.dismiss();
                Toast.makeText(SpreadSheet.this,response,Toast.LENGTH_LONG).show();
                empty();
            ...
            public void onErrorResponse(VolleyError error) {
                loading.dismiss();
                Toast.makeText(SpreadSheet.this,error.toString(),Toast.LENGTH_LONG).show();
            }
        }){
            @Override
...
//        RetryPolicy retryPolicy = new DefaultRetryPolicy(socketTimeOut,0,DefaultRetryPolicy.DEFAULT_BACKOFF_MULT);
 //       stringRequest.setRetryPolicy(retryPolicy);
        RequestQueue addQueue = Volley.newRequestQueue(SpreadSheet.this);
